...
function searchCondition() {
  ...
  fetch('travel_recommendation_api.json')
    ...
    .then(data => {
      ...
      if(input ==='australia' || input ==='japan' || input ==='brazil' || input ==='country'){ 
           resultDiv.innerHTML += `<h2>Search Result</h2><br><br>`;
              data.countries.forEach(country => {
                ...
                country.cities.forEach(city => {
                    ...
                    resultDiv.innerHTML +=			  
                        `<div class="country">							  
                        <img src="${city.imageUrl}" height="60%" width="100%">
                        <h2>${city.name}</h2>
                  ...
                  if (city.name.toLowerCase().includes(input)) {
                    ...
                    description: city.description,
                        ...
                        resultDiv.innerHTML +=			  
                        `<div class="country">							  
                        <img src="${result.countryimage}" height="60%" width="100%">
                        <h2>${result.city}</h2>
        ...
        data.temples.forEach(temple => {	
                           resultDiv.innerHTML += `
                          <div class="temple">								
                          <img src="${temple.imageUrl}" height="60%" width="100%">
                          <h2>${temple.name}</h2>
                   ...
                   resultDiv.innerHTML += `<h2>Search Result</h2><br><br>`;
                      data.beaches.forEach(beach => {
                          resultDiv.innerHTML += `
                          <div class="beach">								
                          <img src="${beach.imageUrl}" height="60%" width="100%">
                          <h2>${beach.name}</h2>
